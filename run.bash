...
HTTP_PORT=20001 P2P_PORT=10001 npm run start &
command1PID="$!" #grab the pid

sleep 0.5
HTTP_PORT=20002 P2P_PORT=10002 REMOTE_PEERS=localhost:10001 npm run start &
command2PID="$!" #grab the pid

sleep 0.5
HTTP_PORT=20003 P2P_PORT=10003 REMOTE_PEERS=localhost:10001 npm run start &
